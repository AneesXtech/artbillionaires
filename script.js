...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function handleScroll() {
    ...
    // Desktop sticky menu threshold
    if (desktopHeaderMenu) {
      if (scrollY > 380) {
        desktopHeaderMenu.classList.add('sticky');
      } else {
        desktopHeaderMenu.classList.remove('sticky');
      }
    }
    
    // Mobile sticky header scrolled background
    if (mobileHeader) {
      if (scrollY > 20) {
  ...
  const allProductsCatalog = [
    { title: 'Taj Mahal', price: 1650, image: 'assets/Art Images/Taj Mahal - Oil on Wood  48 x 36 inches  2011.jpg', details: 'Oil on Wood • 48 × 36 inches (2011)' },
    { title: 'Once Upon a Time in America', price: 1450, image: 'assets/Art Images/Once Upon a Time in  America - Oil on Canvas  40 x 30 inches  2015.jpg', details: 'Oil on Canvas • 40 × 30 inches (2015)' },
    { title: "A Lion Queen's Journey", price: 1250, image: 'assets/Art Images/A Lion Queen’s Journey through Eden - Oil on Linen  24 x 30 inches  2023.jpg', details: 'Oil on Linen • 24 × 30 inches (2023)' },
    { title: 'Street-Side Cars', price: 1350, image: 'assets/Art Images/Street-Side Cars  Oil on Wood  32 x 24 inches  2007.jpg', details: 'Oil on Wood • 32 × 24 inches (2007)' },
    { title: 'Cute White Kitty', price: 950, image: 'assets/Art Images/Cute White Kitty - Oil on Paper  29 x 21 inches  2004.jpg', details: 'Oil on Paper • 29 × 21 inches (2004)' },
    { title: 'Doggy Dog', price: 1150, image: 'assets/Art Images/Doggy Dog - Oil on Wood  32 x 24 inches  2006  -T1.jpg', details: 'Oil on Wood • 32 × 24 inches (2006)' },
    { title: 'Shadows of Egret', price: 1550, image: 'assets/Art Images/Shadows of Egret - Oil on Wood  48 x 32 inches  2007.jpg', details: 'Oil on Wood • 48 × 32 inches (2007)' },
    { title: 'Wild Beast', price: 1600, image: 'assets/Art Images/Wild Beast - Oil on Canvas - 48 x 32 inches - 2007.jpg', details: 'Oil on Canvas • 48 × 32 inches (2007)' },
    { title: 'Perched Beauty of Nature', price: 1300, image: 'assets/Art Images/Perched Beauty of Nature  - Oil on Wood  48 x 32 inches  2006.jpg', details: 'Oil on Wood • 48 × 32 inches (2006)' },
    { title: 'Cars in Town', price: 1450, image: 'assets/Art Images/Cars in Town  Oil on Wood  48 x 32 inches  2007.jpg', details: 'Oil on Wood • 48 × 32 inches (2007)' }
  ];
  ...
  const productCategories = {
    'Taj Mahal': ['Architectural', 'Featured Art'],
    'Once Upon a Time in America': ['Humans', 'Featured Art'],
    "A Lion Queen's Journey": ['Animals', 'Featured Art'],
    'Street-Side Cars': ['Architectural', 'Featured Art'],
    'Cute White Kitty': ['Animals', 'Featured Art'],
    'Doggy Dog': ['Animals', 'Featured Art'],
    'Shadows of Egret': ['Birds', 'Featured Art'],
    'Wild Beast': ['Animals', 'Featured Art'],
    'Perched Beauty of Nature': ['Birds', 'Featured Art'],
    'Cars in Town': ['Architectural', 'Featured Art']
  };
  ...
  document.querySelectorAll('.category-option').forEach(option => {
    option.addEventListener('click', (e) => {
      ...
      productCards.forEach(card => {
        ...
        const allowedCategories = productCategories[title] || ['Featured Art'];
        
        if (allowedCategories.includes(selectedCategory) || selectedCategory === 'Featured Art') {
          card.style.display = '';
        } else {
  ...
  shareBtn?.addEventListener('click', () => {
    ...
    if (navigator.share) {
      navigator.share({
        title: 'Art Millionaires',
        text: 'Discover original, hand-painted canvas artworks by Art Millionaires.',
        url: shareUrl
  ...
  const tabBtns = document.querySelectorAll('.selection-tab-btn');
  ...
  function renderAccountWishlist() {
    ...
    wishlistItems.forEach(item => {
      ...
      card.innerHTML = `
        <div style="aspect-ratio: 1060/753; background-image: url('assets/product-frame.png'); background-size: 100% 100%; position: relative;">
          <div style="position: absolute; top: 10.89%; left: 7.92%; width: 85.48%; height: 77.95%; overflow: hidden; display: flex; align-items: center; justify-content: center; background: #0b0704;">
  ...
  function renderWishlistPage() {
    ...
    wishlistItems.forEach(item => {
      ...
      card.innerHTML = `
        <div class="product-img-link" style="aspect-ratio: 1060 / 753; position: relative;">
          <div class="museum-frame" style="position: relative; width: 100%; aspect-ratio: 1060 / 753; background-image: url('assets/product-frame.png'); background-size: 100% 100%; background-repeat: no-repeat;">
            <div class="museum-frame-inner" style="position: absolute; top: 10.89%; left: 7.92%; width: 85.48%; height: 77.95%; overflow: hidden; display: flex; align-items: center; justify-content: center; background: #0b0704;">
              <img src="${item.image}" alt="${item.title}" class="product-img canvas-image" style="width: 100%; height: 100%; object-fit: contain;">
            </div>
          </div>
        </div>
